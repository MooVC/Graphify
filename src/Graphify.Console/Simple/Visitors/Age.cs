    ...
    : IVisitor<Simple.Graph.Age, string>
{
    ...
    public async IAsyncEnumerable<string> Observe(Simple.Graph.Age instance, [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        yield return $"Simple.Graph.Age: {instance.Value}";
    }
}