namespace Graphify.Semantics
{
    ...
    internal static partial class ISymbolExtensions
    {
        ...
        public static bool IsAttribute(this ISymbol subject, string name)
        {
            ...
            string fullyQualifiedName = $"Graphify.{qualifiedName}";
            ...
            bool IsQualified()
            {
                string qualification = subject.ToDisplayString(_fullyQualifiedFormat);

                return qualification == qualifiedName || qualification == fullyQualifiedName || qualification == globalQualifiedName;
            }
